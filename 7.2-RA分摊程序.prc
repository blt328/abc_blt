create or replace procedure p_abc_fct_ra_dist(p_to_dt date default sysdate) is
  /*************************************************************
   author  : blt
   created : 2019-06-30
   purpose :
...
begin
  ...
  v_sqlstate := '删除数据';
  delete abc_fct_ra_dist_tmp01;
  delete abc_fct_ra_dist_tmp02;
  delete abc_fct_ra_dist_tmp03;
  delete abc_fct_ra_dist_tmp04;
  delete abc_fct_ra_dist a where a.month_code = v_month;
  ...
  insert into abc_fct_ra_dist_tmp02
    select fm_dept_code,
           ...
           fm_car,
           sum(fm_amt) fm_amt
      from (select a.to_dept_code fm_dept_code,
             ...
             where a.month_code = v_month
               and a.to_amt <> 0
            union all
            select b.dept_code, b.func_code, b.reso_code, b.car_no, b.amt
  ...
  insert into abc_fct_ra_dist_tmp04
    select a.mode_code,
           ...
           nvl(b.acti_code, a.to_acti_code) to_acti_code,
           a.dist_type,
           a.driv_code,
           a.driv_name,
           b.qty,
